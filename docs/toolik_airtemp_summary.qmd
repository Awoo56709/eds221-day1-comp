...
First read in data - chlorophyll
...
## get data overview
```{r}
skimr::skim("toolik_chlorophyl")
dim(toolik_chlorophyll)
names(toolik_chlorophyll)

```
# CLEAN THE NAME WITH JANITOR
...
#convert chlorophyll into numeric
...
theme_minimal() +
  labs(title = "Toolik Lake Chlorophyll a Concentration",
       x = "Depth (M)",
       y = "Cholorphyll a Concentration (Micrograms per liter")

#Save plot
ggsave(here::here("figs","toolik_cholorphyll_plot.png"), height = 6, width = 7)
